...
import { listCategories, nextNameForCategory, nextUntaggedName, previewUntaggedName, totalEntryCount } from '../db/categories';
...
export default function RecordScreen({ navigation }) {
  ...
  const refreshCategories = useCallback(() => listCategories().then(setCategories), []);
          ...
          <>
            ...
            <View style={styles.secondaryRow}>
              ...
              >
                ...
                <Text style={{ color: theme.text, fontWeight: '600' }}>Stop</Text>
              </TouchableOpacity>
            </View>
          </>
        )}
